...
/**
 * Extract the token from the Authorization header or session/auth cookie.
 */
...
export async function verifyIdToken(token) {
  try {
    ...
    // Token version check: If user's password was changed or sessions revoked, invalidate older tokens
    ...
    // Account status check: Reject if banned or deactivated

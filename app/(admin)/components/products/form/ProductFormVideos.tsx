    ...
    <div className="space-y-4">
      ...
      {validationErrors.length > 0 && (
        <div className="p-3 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg">
          <p className="text-sm font-medium text-red-800 dark:text-red-200 mb-2">Video Validation Errors:</p>
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
        ...
        <label className="w-full h-40 flex flex-col items-center justify-center border-2 border-dashed border-theme-border-light dark:border-theme-border-dark rounded-lg cursor-pointer hover:border-theme-primary hover:bg-theme-hover-bg-light dark:hover:bg-theme-hover-bg-dark transition-all">
          ...
          <span className="text-sm text-theme-text-muted-light dark:text-theme-text-muted-dark font-medium">Upload Videos</span>
          <span className="text-xs text-theme-text-muted-light dark:text-theme-text-muted-dark mt-1">MP4, WebM, MOV</span>
          <input type="file" multiple accept="video/mp4,video/webm,video/quicktime" onChange={handleFileChange} className="hidden" />
        </label>
      </div>
    </div>
  );

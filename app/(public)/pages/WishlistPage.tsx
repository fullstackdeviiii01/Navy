            ...
            <div className="border border-dashed border-theme-border-light dark:border-theme-border-dark bg-theme-surface-light dark:bg-theme-surface-dark p-12 sm:p-20 text-center max-w-2xl mx-auto space-y-6" role="status" aria-live="polite">
              ...
              <div className="pt-4">
                <button
                  ...
                  className="inline-flex items-center gap-2 px-8 py-4 bg-theme-primary hover:bg-theme-hover-light dark:hover:bg-theme-hover-dark text-theme-btn-text text-xs uppercase tracking-[0.2em] font-medium transition-colors"

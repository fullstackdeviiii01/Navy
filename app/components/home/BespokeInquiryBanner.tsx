...
export default function BespokeInquiryBanner() {
  ...
  return (
    <section className="bg-theme-bg-light dark:bg-theme-bg-dark border-t border-theme-border-light dark:border-theme-border-dark py-4 sm:py-5 md:py-7 transition-colors">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-10 items-stretch">
          
          {/* LEFT: Studio Advisory Card (5 Cols) */}
          <div className="lg:col-span-5 p-4 sm:p-6 lg:p-8 border border-theme-border-light dark:border-theme-border-dark bg-theme-surface-light dark:bg-theme-surface-dark flex flex-col justify-between space-y-4 sm:space-y-6 relative overflow-hidden">
            ...
            <div className="relative z-10 space-y-4 sm:space-y-5">
              <div className="flex items-center justify-between border-b border-theme-border-light/60 dark:border-theme-border-dark/60 pb-3 sm:pb-4">
                <span className="font-mono text-[9px] sm:text-[10px] uppercase tracking-[0.25em] text-theme-hover-light dark:text-theme-hover-dark font-medium">
                  STUDIO CONCIERGE
                </span>
                <span className="font-mono text-[9px] sm:text-[10px] uppercase tracking-wider text-theme-text-muted-light dark:text-theme-text-muted-dark">
                  AVAILABLE 7 DAYS
                </span>
              </div>

              <div className="space-y-2 sm:space-y-3">
                <h3 className="text-xl sm:text-2xl lg:text-3xl font-serif text-theme-text-primary-light dark:text-theme-text-primary-dark leading-snug">
              ...
              <div className="space-y-2.5 sm:space-y-3 pt-1 sm:pt-2">
                <div className="flex items-center gap-2.5 sm:gap-3 text-xs text-theme-text-primary-light dark:text-theme-text-primary-dark">
                  <Clock className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-theme-hover-light dark:text-theme-hover-dark shrink-0" />
                  <span className="font-mono text-[10px] sm:text-[11px] uppercase tracking-wider">Average inquiry response: Under 2 hours</span>
                </div>
                <div className="flex items-center gap-2.5 sm:gap-3 text-xs text-theme-text-primary-light dark:text-theme-text-primary-dark">
                  <Mail className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-theme-hover-light dark:text-theme-hover-dark shrink-0" />
                  <span className="font-mono text-[10px] sm:text-[11px] uppercase tracking-wider">Direct craftsman consultation</span>
                </div>
                <div className="flex items-center gap-2.5 sm:gap-3 text-xs text-theme-text-primary-light dark:text-theme-text-primary-dark">
                  <ShieldCheck className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-theme-hover-light dark:text-theme-hover-dark shrink-0" />
                  <span className="font-mono text-[10px] sm:text-[11px] uppercase tracking-wider">Complimentary space advice</span>
                </div>
              </div>
            </div>
          ...
          <div className="lg:col-span-7 flex flex-col justify-between space-y-5 sm:space-y-6">
            ...
            <div className="grid grid-cols-1 gap-3 sm:gap-4 pt-1 sm:pt-2">
              {consultationPillars.map((pillar) => (
                <div
                  key={pillar.num}
                  className="p-4 sm:p-5 md:p-6 border border-theme-border-light dark:border-theme-border-dark bg-theme-surface-light dark:bg-theme-surface-dark flex flex-col sm:flex-row sm:items-center justify-between gap-3 sm:gap-4 group hover:border-theme-hover-light transition-colors"
                >

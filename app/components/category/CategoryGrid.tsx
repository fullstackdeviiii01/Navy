    ...
    return (
      <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-6 lg:gap-8">
        {[...Array(6)].map((_, i) => (
          ...
          >
            <div className="h-8 sm:h-10 bg-theme-card-light/40 dark:bg-theme-card-dark/40 border-b border-theme-border-light/40 dark:border-theme-border-dark/40" />
            <div className="aspect-[4/3] bg-theme-card-light/60 dark:bg-theme-card-dark/60" />
            <div className="p-3 sm:p-6 space-y-2 sm:space-y-3">
              <div className="h-4 sm:h-6 bg-theme-card-light/80 dark:bg-theme-card-dark/80 w-2/3" />
              <div className="h-2.5 sm:h-3 bg-theme-card-light/50 dark:bg-theme-card-dark/50 w-full" />
            </div>
          </div>
        ))}
      </div>
        ...
        {categories.map((category, index) => {
          ...
          return (
            <Link
              ...
              className="group flex flex-col sm:flex-row sm:items-center justify-between p-4 sm:p-8 hover:bg-theme-card-light/40 dark:hover:bg-theme-card-dark/40 transition-colors gap-3 sm:gap-4"
            >
              <div className="flex items-start sm:items-center gap-3 sm:gap-6">
                <span className="font-mono text-xs sm:text-sm tracking-[0.2em] text-theme-hover-light dark:text-theme-hover-dark font-semibold">
                  N° {indexFormatted}
                </span>
                <div>
                  <h3 className="text-lg sm:text-3xl font-serif text-theme-text-primary-light dark:text-theme-text-primary-dark group-hover:text-theme-hover-light dark:group-hover:text-theme-hover-dark transition-colors">
                    {category.name}
                  </h3>
              ...
              <div className="flex items-center justify-between sm:justify-end gap-4 sm:gap-8 pt-2 sm:pt-0 border-t sm:border-t-0 border-theme-border-light/40 dark:border-theme-border-dark/40">
                <span className="font-mono text-[10px] sm:text-xs uppercase tracking-[0.15em] text-theme-text-muted-light dark:text-theme-text-muted-dark">
                  {category.product_count} {category.product_count === 1 ? "Piece" : "Pieces"}
                </span>
                <span className="inline-flex items-center gap-1.5 sm:gap-2 text-[11px] sm:text-xs uppercase tracking-[0.2em] font-medium text-theme-text-primary-light dark:text-theme-text-primary-dark group-hover:text-theme-hover-light dark:group-hover:text-theme-hover-dark transition-colors">
                  <span>Explore</span>
